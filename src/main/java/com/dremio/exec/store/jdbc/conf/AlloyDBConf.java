...
@SourceType(value = "AlloyDBARP", label = "AlloyDB",uiConfig = "alloydb-layout.json")
public class AlloyDBConf extends AbstractArpConf<AlloyDBConf> {
  private static final String ARP_FILENAME = "arp/implementation/alloydb-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.alloydb.AlloyDBDriver";
